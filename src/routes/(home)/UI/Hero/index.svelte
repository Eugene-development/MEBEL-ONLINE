<div class="pt-20 pb-16 text-center lg:pt-32">
    <h1 class="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl">
      ...
      без салонов и переплат
    </h1>
    <p class="mx-auto px-3 mt-6 max-w-2xl text-lg tracking-tight text-slate-700">
      Пригласите нашего представителя на объект для получения полной консультации. Закажите мебель напрямую и <span class="text-blue-600">сэкономьте</span> на цене <span class="text-blue-600">до 50%</span>.
    </p>
      ...
      >
        {[
          ...
          <li key={groupIndex}>
            ...
            >
              {group.map((company) => (
                <li key={company.name} class="flex">
